class Jinja2CliIcasture < Formula
  include Language::Python::Virtualenv

  desc "CLI for the Jinja2 templating language, modified from mattrobenolt's version"
  homepage "https://github.com/iCasture/jinja2-cli/blob/main/README.md"
  head "https://github.com/iCasture/jinja2-cli.git", branch: "master"
  ...
  conflicts_with "jinja2-cli",
  because: "this formula is a modified version of jinja2-cli and cannot coexist with it"
